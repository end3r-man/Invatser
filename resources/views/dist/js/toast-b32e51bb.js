...
`, P = `
  ...
  <\/script>
`, $ = createCodeViewer("#toast-basic-code-viewer", M), F = createCodeViewer("#toast-type-code-viewer", R), A = createCodeViewer("#toast-placement-code-viewer", j), z = createCodeViewer("#toast-closeable-code-viewer", D), _ = createCodeViewer("#toast-custom-code-viewer", P); y && y.addEventListener("click", () => n("Hello, I am a Toast")); v && v.addEventListener("click", () => { n.success("Hello, I am a Success Toast") }); w && w.addEventListener("click", () => { n.danger("Hello, I am a Danger Toast") }); k && k.addEventListener("click", () => { n.warning("Hello, I am a Warning Toast") }); C && C.addEventListener("click", () => { n.info("Hello, I am an Info Toast") }); L && L.addEventListener("click", () => { n("Hello, I am a Toast", { gravity: "top", position: "right" }) }); S && S.addEventListener("click", () => { n("Hello, I am a Toast", { gravity: "top", position: "center" }) }); E && E.addEventListener("click", () => { n("Hello, I am a Toast", { gravity: "top", position: "left" }) }); I && I.addEventListener("click", () => { n("Hello, I am a Toast", { gravity: "bottom", position: "right" }) }); H && H.addEventListener("click", () => { n("Hello, I am a Toast", { gravity: "bottom", position: "center" }) }); N && N.addEventListener("click", () => { n("Hello, I am a Toast", { gravity: "bottom", position: "left" }) }); x && x.addEventListener("click", () => { n("Hello, I am a Toast", { close: !0 }) }); q && q.addEventListener("click", () => { n("Hello, I am a <strong>Custom Toast</strong>", { style: { background: "#a855f7", color: "#fff" } }) }); $.render(); F.render(); A.render(); z.render(); _.render();
