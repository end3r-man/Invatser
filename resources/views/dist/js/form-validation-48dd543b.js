import "./app.js";/* empty css            */const l = `
  ...
  <\/script>
`, a = document.querySelector("#form-custom-validation"), s = createCodeViewer("#custom-form-validation-code-viewer", l); a && a.addEventListener("submit", function (e) { this.checkValidity() || (e.preventDefault(), e.stopPropagation()), this.classList.add("form-validated") }); s.render();
