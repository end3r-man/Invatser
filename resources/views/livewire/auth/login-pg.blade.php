                ...
                <div class="card-body px-10 py-12">
                    ...
                    <div class="mt-6 flex flex-col gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model='email' class="input" placeholder="Enter Your Email" required/>
                        </div>
                        <!-- Password-->
                        <div class="">
                            <label class="label mb-1">Password</label>
                            <input type="password" wire:model='password' class="input" placeholder="Password" required/>
                        </div>
                    </div>
                    ...
                    <!-- Login Button -->
                    <div class="mt-8">
                        <button class="btn bg-[#8b5cf6] w-full py-2.5" type="submit">Login</button>
                    </div>
                    </form>
                    ...
                    <div class="mt-4 flex justify-center">
                        <p class="text-sm text-slate-600 dark:text-slate-300">
                            Don't Have an Account?
                            <a href="{{route('signup')}}" wire:navigate class="text-sm text-primary-500 hover:underline">Sign up</a>
                        </p>
                    </div>
                </div>
            </div>
